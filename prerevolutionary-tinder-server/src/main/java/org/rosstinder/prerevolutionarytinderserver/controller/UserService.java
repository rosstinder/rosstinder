...
public class UserService implements Service {
    ...
    public UserService() {
        ...
        this.users.add(new User(1, "user1", Gender.MALE, "Некто", "Интеллигентный",
        ...
        this.users.add(new User(2, "user2", Gender.FEMALE, "Никто", "Желаю выйти замуж",
    ...
    @Override
    public User findById(int chatId) {
